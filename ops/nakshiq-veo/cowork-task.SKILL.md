...
PART A — probe part 2 (budget under 40 credits; do it first, it is quick):
  ...
  A3. Write ~/Downloads/nakshiq-veo-inbox/probe/probe-report.md: for A1, does it start exactly where shot 1 ended and keep the same man, woman, car and blue hour? Model and credits charged. For A2, the two models. Also: credits charged per Nano Banana still if you can read it. Also the keyframe-probe answer from Part B step 2b, once you reach it.
