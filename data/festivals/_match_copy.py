...
acct_n=int(os.environ.get('ACCT','6'))
sl=int(os.environ.get('SLICE_START','25'))
ext=os.path.join(base,'_inbox',f'acct{acct_n}_{today}','extracted')
...
acct=batch[sl:sl+5]
STOP=set('cinematic documentary style video seconds authentic real footage look of the festival as celebrated in celebration parade goa mp4 new year annual at'.split())
