#!/usr/bin/env python3
"""NakshIQ daily QA probe — 2026-07-02. Sections A,B,C,D,E,F,G,H,I,J.
...
UA = "NakshIQ-DailyQA/2026-07-02 (curl probe; Cowork scheduled task)"
BODYF = "/tmp/_body_20260702"
...
def get_sample():
    ...
    slugs = sorted(slugs)
    random.seed("nakshiq-2026-07-02")
...
# ---------- F: API smoke ----------
def sec_f():
    open("/tmp/_oversized_20260702.json", "w").write("x" * 200000)
    probes = [
        ...
        ("POST /api/chat oversized-200KB", f"{BASE}/api/chat", "POST", "@/tmp/_oversized_20260702.json", ["Content-Type: application/json"]),
