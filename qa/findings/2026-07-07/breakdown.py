#!/usr/bin/env python3
"""Section H — full per-type sitemap composition for 2026-07-07.
Categorises every <loc> across all chunks and writes section-H-sitemap-breakdown.txt,
then diffs the OVERALL-by-type table against yesterday's (2026-07-06) stored breakdown."""
...
# diff vs yesterday
ypath = os.path.join(EVID, "..", "2026-07-06", "section-H-sitemap-breakdown.txt")
if os.path.exists(ypath):
    ...
    print("\n=== DELTA vs 2026-07-06 (today - yesterday) ===")
