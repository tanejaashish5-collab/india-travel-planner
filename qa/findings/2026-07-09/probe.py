#!/usr/bin/env python3
"""NakshIQ daily QA probe — 2026-07-09. Sections A,B,C,D,E,F,G,H,I,J.
...
UA = "NakshIQ-DailyQA/2026-07-09 (curl probe; Cowork scheduled task)"
BODYF = "/tmp/_body_20260709"
...
def get_sample():
    ...
    slugs = sorted(slugs)
    random.seed("nakshiq-2026-07-09")
...
def sec_f(part=0, _unused=None):
    open("/tmp/_oversized_20260709.json", "w").write("x" * 200000)
    p1 = [
        ...
        ("POST /api/chat oversized-200KB", f"{BASE}/api/chat", "POST", "@/tmp/_oversized_20260709.json", ["Content-Type: application/json"]),
