#!/usr/bin/env python3
"""NakshIQ daily QA probe — 2026-06-17. Sections A,B,C,D,E,F,G,H,I,J.
...
UA = "NakshIQ-DailyQA/2026-06-17 (curl probe; Cowork scheduled task)"
BODYF = "/tmp/_body_20260617"
...
def get_sample():
    ...
    slugs = sorted(slugs)
    random.seed("nakshiq-2026-06-17")
...
# ---------- F: API smoke ----------
def sec_f():
    open("/tmp/_oversized_20260617.json", "w").write("x" * 200000)
    probes = [
        ...
        ("POST /api/chat oversized-200KB", f"{BASE}/api/chat", "POST", "@/tmp/_oversized_20260617.json", ["Content-Type: application/json"]),
