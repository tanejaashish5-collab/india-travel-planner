#!/usr/bin/env python3
"""NakshIQ daily QA probe script — 2026-08-30 run.
Carried forward verbatim in methodology from 2026-08-27/probe.py (the most
recent COMPLETE prior run) per the standing copy-forward convention.
SEED/date changed. Only 1 commit landed on origin/main since 08-27's QA
session (a GA4-audit markdown file, no app code) so no new API fixtures
were needed this run — the webhook/resend fixtures added 08-27 are now
standing checks, kept as-is.
"""
