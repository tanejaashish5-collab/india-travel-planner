#!/usr/bin/env python3
"""NakshIQ daily QA probe script — 2026-08-19 run.
Carried forward verbatim in methodology from 2026-08-17/probe.py (the most
recent COMPLETE prior run — 2026-08-18's run produced this same HTTP-probe
evidence set but was interrupted before findings.json/DB/Chrome stages, so
there is no 2026-08-18.json to treat as the regression baseline; 08-17 is
used instead). Only the SEED/date changed.
"""
