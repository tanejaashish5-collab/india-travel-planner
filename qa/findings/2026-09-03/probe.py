#!/usr/bin/env python3
"""NakshIQ daily QA probe script — 2026-09-03 run.
Carried forward verbatim in methodology from 2026-08-30/probe.py (the most
recent prior run). SEED/date changed. No app-code diff was found between
08-27's confirmed-healthy deploy and today's session start (per 08-30's own
git diff verification and the DPL note), so no new API fixtures were needed —
the webhook/resend fixtures added 08-27 remain standing checks, kept as-is.
"""
