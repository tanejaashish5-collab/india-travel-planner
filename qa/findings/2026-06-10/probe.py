#!/usr/bin/env python3
"""NakshIQ daily QA probe — 2026-06-10. Sections A,B,C,D,E,F,G,H,I,J.
...
UA = "NakshIQ-DailyQA/2026-06-10 (curl probe; Cowork scheduled task)"
BODYF = "/tmp/_body_20260610"
...
def get_sample():
    ...
    slugs = sorted(slugs)
    random.seed("nakshiq-2026-06-10")
