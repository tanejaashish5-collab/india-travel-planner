...
const ROWS = [
  ...
  { id: "pawapuri", slot: "eateries", category: "sub_5k_tribal",
    specifics: { base_town: "Bihar Sharif", base_distance_km: 10,
      note: "Jain pilgrim village where Mahavira attained nirvana — temple annadanam carries the dining; standalone restaurants sit in Bihar Sharif." } },
  { id: "pawapuri", slot: "gems", category: "sub_5k_tribal",
    specifics: { base_town: "Bihar Sharif", base_distance_km: 10,
      note: "The pilgrimage itself is the experience — Jal Mandir on the lotus pond plus Samavasaran is what you came for; no curated checklist beyond that." } },
  { id: "pulicat-lake", slot: "eateries", category: "np_core",
    specifics: { base_town: "Sullurpeta", base_distance_km: 11,
      note: "Bird Sanctuary buffer — the fringe village is a birding hamlet, not a market; eat in Sullurpeta on the way." } },
  { id: "maredumilli", slot: "eateries", category: "sub_5k_tribal",
    specifics: { base_town: "Rampachodavaram", base_distance_km: 35,
      note: "Tribal eco-tourism on community-owned forests — bamboo chicken and meals come from tribal homestays, not standalone restaurants." } },
  { id: "belum-caves", slot: "eateries", category: "sub_5k_tribal",
    specifics: { base_town: "Tadipatri", base_distance_km: 30,
      note: "Belum village (~3,000) is a day-trip cave site; commercial dining sits in Tadipatri." } },
  { id: "gandikota", slot: "eateries", category: "sub_5k_tribal",
    specifics: { base_town: "Jammalamadugu", base_distance_km: 18,
      note: "Fort village of ~3,000 above the Pennar gorge — APTDC Haritha canteen and a handful of stalls are it; restaurants sit in Jammalamadugu." } },
