...
const { data: dests } = await s.from("destinations").select("id, name, region, tagline").eq("state_id", "andhra-pradesh").order("id");
console.log(`Andhra Pradesh destinations: ${dests.length}\n`);
