...
const dests = [
  "baripada","bhitarkanika","bhubaneswar","chandipur","chilika-lake","cuttack","daringbadi","deomali","dhauli","diamond-triangle",
  "gahirmatha","gopalpur-on-sea","konark","koraput","nrusinghanath-harishankar","puri","raghurajpur","sambalpur","satkosia","simlipal","talasari","taptapani",
];
