...
const { data: dests } = await s.from("destinations").select("id, name, region, tagline").eq("state_id", "karnataka").order("id");
console.log(`Karnataka destinations: ${dests.length}\n`);
