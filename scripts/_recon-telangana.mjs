...
const { data: dests } = await s.from("destinations").select("id, name, region, tagline").eq("state_id", "telangana").order("id");
console.log(`Telangana destinations: ${dests.length}\n`);
