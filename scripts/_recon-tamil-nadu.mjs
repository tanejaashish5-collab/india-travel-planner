...
const { data: dests } = await s.from("destinations").select("id, name, region, tagline").eq("state_id", "tamil-nadu").order("id");
console.log(`Tamil Nadu destinations: ${dests.length}\n`);
