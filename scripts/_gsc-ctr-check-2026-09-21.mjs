...
// One-off (gen 2026-09-21 by scheduled gsc-canonical-consolidation task):
// 14th re-run of the Apr 27 snippet-rewrite CTR check. Prior runs
...
// itself is healthy.
// This run only refreshes the RECENT window (Aug 25 - Sep 21, 28d) to check
...
const WINDOWS = [
  ...
  { key: "recent", label: "RECENT28d (Aug 25 - Sep 21)", startDate: "2026-08-25", endDate: "2026-09-21" },
];
...
console.log(`GSC CTR check — Apr 27 snippet rewrite (14th re-run)\n`);
console.log(`Property: ${SITE_URL}`);
console.log(`Windows: PRE (Mar 30-Apr 26) vs JUNE-FULL (Jun 1-30) vs RECENT28d (Aug 25-Sep 21)\n`);
