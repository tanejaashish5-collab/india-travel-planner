...
const dests = [
  "alleppey", "athirapally", "bekal", "beypore", "cherai", "chinnar",
  "eravikulam", "guruvayur", "idukki", "kannur", "kochi", "kollam",
  "kovalam", "kozhikode", "kumarakom", "kumbalangi", "kuttanad",
  "marari", "munnar", "nelliyampathy", "ponmudi", "poovar",
  "sabarimala", "silent-valley", "thekkady", "thrissur", "trivandrum",
  "vagamon", "varkala", "wayanad",
];
