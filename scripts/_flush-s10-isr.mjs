...
const dests = [
  // HP (9)
  "chail", "jibhi", "keylong", "kullu", "lahaul-valley", "mandi", "palampur", "parvati-valley", "solan",
  // UK East + outliers (8)
  "bhimtal", "binsar", "champawat", "chaukori", "pithoragarh", "kanatal", "patnitop", "kargil",
  // UK West (8)
  "chakrata", "dhanaulti", "gopeshwar", "guptkashi", "joshimath", "landour", "tehri", "uttarkashi",
];
