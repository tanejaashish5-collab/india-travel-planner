...
const dests = [
  "agonda", "anjuna", "arambol", "assagao", "calangute-baga", "candolim",
  "chorao-divar", "colva-benaulim", "dudhsagar-falls", "fort-aguada",
  "mandrem", "margao", "mollem", "morjim", "old-goa", "palolem",
  "panaji", "ponda-spice", "reis-magos", "siolim", "vagator",
];
