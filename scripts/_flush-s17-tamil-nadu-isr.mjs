...
const dests = [
  "anamalai", "chennai", "chettinad", "chidambaram", "coimbatore",
  "coonoor", "courtallam", "dhanushkodi", "hogenakkal", "kanchipuram",
  "kanyakumari", "kodaikanal", "kotagiri", "kumbakonam", "madurai",
  "mahabalipuram", "meghamalai", "mudumalai", "ooty", "point-calimere",
  "pondicherry", "rameswaram", "srirangam", "thanjavur", "tharangambadi",
  "tiruvannamalai", "trichy", "valparai", "vedanthangal", "yercaud",
];
