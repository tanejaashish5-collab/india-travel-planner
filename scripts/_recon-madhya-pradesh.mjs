...
const { data: dests } = await s.from("destinations").select("id, name, region, tagline").eq("state_id", "madhya-pradesh").order("id");
console.log(`Madhya Pradesh destinations: ${dests.length}\n`);
