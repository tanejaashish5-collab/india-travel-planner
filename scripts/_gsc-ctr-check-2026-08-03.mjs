...
// One-off (gen 2026-08-03 by scheduled gsc-canonical-consolidation task):
// 7th re-run of the Apr 27 snippet-rewrite CTR check. Prior runs
...
// itself is healthy.
// This run only refreshes the RECENT window (Jul 7 - Aug 3, 28d) to check
// for drift since 07-27; pre/june-full windows kept identical to all prior
...
const WINDOWS = [
  ...
  { key: "recent", label: "RECENT28d (Jul 07 - Aug 03)", startDate: "2026-07-07", endDate: "2026-08-03" },
];
...
console.log(`GSC CTR check — Apr 27 snippet rewrite (7th re-run)\n`);
console.log(`Property: ${SITE_URL}`);
console.log(`Windows: PRE (Mar 30-Apr 26) vs JUNE-FULL (Jun 1-30) vs RECENT28d (Jul 7-Aug 3)\n`);
