...
const { data: dests } = await s.from("destinations").select("id, name, region, tagline").eq("state_id", "chhattisgarh").order("id");
console.log(`Chhattisgarh destinations: ${dests.length}\n`);
