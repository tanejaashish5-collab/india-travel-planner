...
// 11th re-run of the Apr 27 snippet-rewrite CTR check. Prior runs
...
// This run only refreshes the RECENT window (Aug 04 - Aug 31, 28d) to check
// for drift since 08-24; pre/june-full windows kept identical to all prior
...
const WINDOWS = [
  ...
  { key: "recent", label: "RECENT28d (Aug 04 - Aug 31)", startDate: "2026-08-04", endDate: "2026-08-31" },
];
...
console.log(`GSC CTR check — Apr 27 snippet rewrite (11th re-run)\n`);
console.log(`Property: ${SITE_URL}`);
console.log(`Windows: PRE (Mar 30-Apr 26) vs JUNE-FULL (Jun 1-30) vs RECENT28d (Aug 4-31)\n`);
