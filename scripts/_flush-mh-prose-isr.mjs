...
const dests = [
  "mumbai","elephanta-caves","alibaug","murud-janjira","harihareshwar","kashid","ganpatipule","ratnagiri","malvan","tarkarli","amboli","raigad-fort",
  "lonavala","khandala","matheran","mahabaleshwar","panchgani","igatpuri","bhandardara","kolad","bhimashankar","trimbakeshwar","nashik",
  "pune","aurangabad","ajanta-caves","ellora-caves","daulatabad","lonar-crater","shirdi","kolhapur","satara","nagpur","tadoba","pench-maharashtra",
];
