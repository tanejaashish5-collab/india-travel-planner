...
const dests = [
  "ahobilam", "amaravati", "araku-valley", "belum-caves", "gandikota",
  "horsley-hills", "konaseema", "lambasingi", "lepakshi", "machilipatnam",
  "maredumilli", "nagarjuna-sagar", "pulicat-lake", "rajahmundry", "srikalahasti",
  "srisailam", "tirupati", "undavalli-caves", "vijayawada", "visakhapatnam",
];
