...
// One-off (gen 2026-08-24 by scheduled gsc-canonical-consolidation task):
// 10th re-run of the Apr 27 snippet-rewrite CTR check. Prior runs
// (2026-06-22, 2026-06-29, 2026-07-06, 2026-07-13, 2026-07-20, 2026-07-27,
// 2026-08-03, 2026-08-10, 2026-08-17) all concluded the same thing: 5 of 6
...
// on the exact query string but the page itself is healthy.
// This run only refreshes the RECENT window (Jul 28 - Aug 24, 28d) to check
// for drift since 08-17; pre/june-full windows kept identical to all prior
...
const WINDOWS = [
  ...
  { key: "recent", label: "RECENT28d (Jul 28 - Aug 24)", startDate: "2026-07-28", endDate: "2026-08-24" },
];
...
console.log(`GSC CTR check — Apr 27 snippet rewrite (10th re-run)\n`);
console.log(`Property: ${SITE_URL}`);
console.log(`Windows: PRE (Mar 30-Apr 26) vs JUNE-FULL (Jun 1-30) vs RECENT28d (Jul 28-Aug 24)\n`);
