...
- [[passion-fit-gate]] — HARD gate: 4 lanes + faceless-only; validation without passion is waste
...
- [[rejected-ideas]] — the graveyard with dated reasons; never re-litigate from scratch; latest: 3 KILL + 1 PROBE (private-premise inversion)
- [[radar-loop]] — the daily pipeline that fed the ledger (disabled 2026-07-13)
...
- [[nate-herk]] — our most-scraped Claude-Code teacher; 8th lead-magnet-machine data point; "we run most of it, video is market-signal not playbook"
