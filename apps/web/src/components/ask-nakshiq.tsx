...
export function AskNakshIQ() {
  ...
  return (
    <>
      {/* Floating trigger button — bottom-left to leave bottom-right corner
          exclusively for the Plan My Trip CTA (sticky-cta.tsx). They were
          colliding when stacked on the same side. */}
      <button
        onClick={() => setOpen((v) => !v)}
