        ...
        <header className="border-b border-white/10 bg-[#0a0a0a]/90 backdrop-blur-xl">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
            ...
            <div className="flex items-center gap-1">
              ...
              <Link href="/en/plan" className="ml-2 rounded-lg bg-[#e5e5e5] px-3 py-1.5 text-sm font-medium text-[#0a0a0a] hover:bg-gray-300 transition-all">AI Plan</Link>
            </div>
          </div>
        </header>
        ...
        <div className="relative flex items-center justify-center px-4 py-24 min-h-[80vh]">
          ...
          <div className="relative max-w-lg text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-4">
              <Link
                href="/en/explore"
                className="rounded-full bg-[#e5e5e5] text-[#0a0a0a] px-8 py-3.5 text-sm font-semibold hover:bg-white transition-all shadow-lg"
              >
