...
export const metadata: Metadata = {
  ...
  description:
    "290+ destinations, 660+ places with monthly suitability scores, kids ratings, safety data, and AI-powered itineraries. The confidence engine for exploring India.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "290+ destinations, 660+ places with monthly scores, kids ratings, safety data, and AI itineraries.",
    type: "website",
    locale: "en_IN",
    siteName: "NakshIQ",
  ...
  twitter: {
    ...
    title: "NakshIQ — Travel Intelligence for India",
    description: "290+ destinations, 660+ places with monthly scores, kids ratings, safety data, and AI itineraries.",
      ...
      <body className="min-h-full flex flex-col bg-background text-foreground text-base pb-16 md:pb-0">
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            description: "Travel intelligence for India. 290+ destinations with monthly scores, kids ratings, safety data, and AI-powered itineraries.",
            sameAs: [],
          }) }}
        />
