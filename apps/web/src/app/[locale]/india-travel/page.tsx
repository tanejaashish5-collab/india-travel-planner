...
export const metadata: Metadata = {
  ...
  description:
    "Honest India travel tips 2026 from an Indian family. Safety, scams, food, transport, and what your guidebook won't tell you. 260+ destinations scored.",
  openGraph: {
    title: "India Travel Guide for International Visitors — NakshIQ",
    description:
    ...
    <div className="min-h-screen">
      ...
      <div className="border-b border-border/50 bg-card/50">
        <div className="mx-auto max-w-4xl px-4 py-5 flex flex-wrap justify-center gap-8 sm:gap-12">
          {[
            { num: "260+", label: "Destinations Scored" },
