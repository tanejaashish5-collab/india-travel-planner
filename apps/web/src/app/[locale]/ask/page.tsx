...
export const metadata: Metadata = {
  ...
  description: "Ask anything about traveling in India. Get instant answers powered by 260+ destinations, 700+ POIs, monthly scores, kids ratings, and safety data.",
};
