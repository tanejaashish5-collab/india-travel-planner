...
export const metadata: Metadata = {
  ...
  description: "Ask anything about traveling in India. Get instant answers powered by 229+ destinations, 699 POIs, monthly scores, kids ratings, and safety data.",
};
