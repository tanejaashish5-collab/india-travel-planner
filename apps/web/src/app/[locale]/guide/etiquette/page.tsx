...
export default async function EtiquetteGuidePage({
  ...
  const articleLd = articleJsonLd({
    ...
    description:
      "Practical cultural etiquette: dress, greetings, dining, religious sites, photography.",
    inLanguage,
  ...
  const sections = [
    {
      id: "dress",
      title: "Dress — simpler than you've been told",
      body: (
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <p style={guideProse}>
            Cover shoulders and knees outside metro centres and beach destinations
            — that&apos;s most of the rule. In Mumbai, Delhi, Bengaluru, and Goa,
            casual western dress fits in. Temples, mosques, gurudwaras, and rural
            villages expect modest cover regardless. A long scarf or shawl in
            your day bag covers all transitions.
          </p>
          <p style={guideProse}>
            Loose breathable cotton or linen handles the climate better than
            synthetic fabrics; pack accordingly. Beachwear stays at the beach;
            don&apos;t walk through villages in swimwear.
          </p>
        </div>
      ),
    },
    {
      ...
      body: (
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <p style={guideProse}>
            Shoes off, always. Shoulders and knees covered. Head covered at
            gurudwaras (a long scarf works) and at some Hindu temples.
            Photography varies — many inner sanctums are off-limits, marked.
            Walk clockwise around shrines (pradakshina). Voices low.
          </p>
          <p style={guideProse}>
            Mosques: women may need a head-cover; some don&apos;t allow non-Muslim
            entry. Buddhist monasteries: walk clockwise around prayer wheels
            and stupas; don&apos;t touch sacred objects without invitation. Sikh
            gurudwaras: covered head, shoes off, hands washed; everyone&apos;s
            welcome including non-Sikhs, and the langar (free communal meal) is
    ...
    },
    {
      ...
      body: (
        <p style={guideProse}>
          Right hand only at thalis and traditional places — left is traditionally
          considered unclean for eating. Don&apos;t share food from your plate
          (it&apos;s considered jhootha — mouth-touched — and unclean for the
          next person). Tipping 10% at restaurants if no service charge already
          added. At someone&apos;s home, polite refusal twice and acceptance on
          the third offer is the conventional dance.
        </p>
      ),
    },
    {
      id: "greetings",
      title: "Greetings, gestures, and the head wobble",
      body: (
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <p style={guideProse}>
            Namaste — palms together at chest, slight bow — is the most respectful
            default and works in any setting. Handshakes are common in business
            and urban settings; many women and men shake. Across most of India,
            opposite-sex public physical contact between strangers is unusual.
          </p>
          <p style={guideProse}>
            The Indian head wobble is the famous source of confusion — a
            side-to-side tilt that can mean &quot;yes&quot;, &quot;I
            understand&quot;, &quot;maybe&quot;, or &quot;okay, sure&quot;
            depending on the speed and context. Mostly it means engaged
            listening and approximate agreement. You&apos;ll calibrate within a
            few days.
          </p>
        </div>
      ),
  ...
  return (
    <>
      ...
      />
      <CinematicGuide
        kicker={`GUIDES · ETIQUETTE · REVIEWED ${REVIEWED}`}
        title="India etiquette — what to know, what relaxes."
        dek="India is a culture of polite specificity. The country is more relaxed than most travel-blog warnings suggest about most things, and more specific than they suggest about a few — temples, dining, photography. Get the few right and the rest takes care of itself."
        sections={sections}
        nextGuide={{
          href: `/${locale}/guide/food-safety`,
