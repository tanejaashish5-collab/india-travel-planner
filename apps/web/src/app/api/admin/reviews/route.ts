/**
 * /api/admin/reviews — Sprint 20 moderation endpoint.
 * Mirrors /api/admin/trip-reports auth + action pattern.
 */
...
export async function GET(req: NextRequest) {
  ...
  let query = supabase
    .from("reviews")
    .select(`
      id, destination_id, rating, text, traveler_type, visit_month, visit_year,
      reporter_name, reporter_email, status, moderator_note,
